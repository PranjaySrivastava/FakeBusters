...
model.eval()
print("✓ Image model loaded (87.6% accuracy)\n")
...
if __name__ == "__main__":
    ...
    if len(sys.argv) < 2:
        print("="*70)
        print("DEEPFAKE VIDEO ANALYZER")
        print("="*70)
        print("\nUsage: python training/predict_video.py <video_path>")
        print("\nExample:")
        print('  python training/predict_video.py "C:\\path\\to\\video.mp4"')
        print("="*70)
        exit(1)
    ...
    print("="*70)
    print("DEEPFAKE VIDEO ANALYZER - Frame-by-Frame Detection")
    print("="*70)
    print()
